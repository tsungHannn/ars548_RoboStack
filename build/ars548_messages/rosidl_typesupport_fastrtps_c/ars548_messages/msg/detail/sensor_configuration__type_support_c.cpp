...
#include "ars548_messages/msg/detail/sensor_configuration__rosidl_typesupport_fastrtps_c.h"
...
using _SensorConfiguration__ros_msg_type = ars548_messages__msg__SensorConfiguration;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SensorConfiguration__ros_msg_type * ros_message = static_cast<const _SensorConfiguration__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: newsensormounting
  {
    cdr << ros_message->newsensormounting;
  }

  // Field name: newvehicleparameters
  {
    cdr << ros_message->newvehicleparameters;
  }

  // Field name: newradarparameters
  {
    cdr << ros_message->newradarparameters;
  }

  // Field name: newnetworkconfiguration
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SensorConfiguration__ros_msg_type * ros_message = static_cast<_SensorConfiguration__ros_msg_type *>(untyped_ros_message);
  // Field name: longitudinal
  {
    cdr >> ros_message->longitudinal;
  }
...
size_t get_serialized_size_ars548_messages__msg__SensorConfiguration(
  const void * untyped_ros_message,
...
static uint32_t _SensorConfiguration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ars548_messages__msg__SensorConfiguration(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ars548_messages
size_t max_serialized_size_ars548_messages__msg__SensorConfiguration(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ars548_messages__msg__SensorConfiguration;
    is_plain =
      (
...
static size_t _SensorConfiguration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ars548_messages__msg__SensorConfiguration(
...
static message_type_support_callbacks_t __callbacks_SensorConfiguration = {
  "ars548_messages::msg",
  "SensorConfiguration",
...
static rosidl_message_type_support_t _SensorConfiguration__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SensorConfiguration,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ars548_messages, msg, SensorConfiguration)() {
  return &_SensorConfiguration__type_support;
}
