        ...
        if pretrained:
            ...
            if in_channels == 4:
                ...
                if k_hit is not None:
                    w3 = state[k_hit]                        # [out, 3, k, k]
                    w4 = torch.cat([w3, w3.mean(dim=1, keepdim=True)], dim=1)  # [out, 4, k, k]
                    state[k_hit] = w4
                    print(f'Load PResNet{depth} pretrained (adapted to 4-ch input).')
                else:
                    pass
                ...
                self.load_state_dict(state, strict=False)  
                print(f'Load PResNet{depth} pretrained (3-ch input).')
