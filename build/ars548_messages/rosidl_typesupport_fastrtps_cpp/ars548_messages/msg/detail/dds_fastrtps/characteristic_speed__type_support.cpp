...
#include "ars548_messages/msg/detail/characteristic_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ars548_messages::msg::CharacteristicSpeed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ars548_messages::msg::CharacteristicSpeed & ros_message)
{
  // Member: characteristicspeederramp
  cdr >> ros_message.characteristicspeederramp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ars548_messages
max_serialized_size_CharacteristicSpeed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ars548_messages::msg::CharacteristicSpeed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ars548_messages::msg::CharacteristicSpeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ars548_messages::msg::CharacteristicSpeed *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CharacteristicSpeed__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ars548_messages::msg::CharacteristicSpeed *>(
...
static size_t _CharacteristicSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CharacteristicSpeed(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CharacteristicSpeed__callbacks = {
  "ars548_messages::msg",
  "CharacteristicSpeed",
...
static rosidl_message_type_support_t _CharacteristicSpeed__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CharacteristicSpeed__callbacks,
...
{
  return &ars548_messages::msg::typesupport_fastrtps_cpp::_CharacteristicSpeed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ars548_messages, msg, CharacteristicSpeed)() {
  return &ars548_messages::msg::typesupport_fastrtps_cpp::_CharacteristicSpeed__handle;
}
