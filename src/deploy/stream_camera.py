...
class SpinnakerCameraNode:
    def __init__(self):
        ...
        self.image_calib_pub = rospy.Publisher('/aravis_cam1/image_color_calib', Image, queue_size=10)
        self.compressed_image_pub = rospy.Publisher('/aravis_cam1/image_color/compressed', CompressedImage, queue_size=10)
