...
#include "ars548_messages/msg/detail/acceleration_longitudinal_co_g__rosidl_typesupport_fastrtps_c.h"
...
using _AccelerationLongitudinalCoG__ros_msg_type = ars548_messages__msg__AccelerationLongitudinalCoG;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AccelerationLongitudinalCoG__ros_msg_type * ros_message = static_cast<const _AccelerationLongitudinalCoG__ros_msg_type *>(untyped_ros_message);
  // Field name: accelerationlongitudinalerramp
  {
    cdr << ros_message->accelerationlongitudinalerramp;
  }

  // Field name: accelerationlongitudinalerramp_invalidflag
  {
    cdr << ros_message->accelerationlongitudinalerramp_invalidflag;
  }

  // Field name: qualifieraccelerationlongitudinal
  {
    cdr << ros_message->qualifieraccelerationlongitudinal;
  }

  // Field name: accelerationlongitudinal
  {
    cdr << ros_message->accelerationlongitudinal;
  }

  // Field name: accelerationlongitudinal_invalidflag
  {
    cdr << ros_message->accelerationlongitudinal_invalidflag;
  }

  // Field name: accelerationlongitudinaleventdataqualifier
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AccelerationLongitudinalCoG__ros_msg_type * ros_message = static_cast<_AccelerationLongitudinalCoG__ros_msg_type *>(untyped_ros_message);
  // Field name: accelerationlongitudinalerramp
  {
    cdr >> ros_message->accelerationlongitudinalerramp;
  }
...
size_t get_serialized_size_ars548_messages__msg__AccelerationLongitudinalCoG(
  const void * untyped_ros_message,
...
static uint32_t _AccelerationLongitudinalCoG__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ars548_messages__msg__AccelerationLongitudinalCoG(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ars548_messages
size_t max_serialized_size_ars548_messages__msg__AccelerationLongitudinalCoG(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ars548_messages__msg__AccelerationLongitudinalCoG;
    is_plain =
      (
...
static size_t _AccelerationLongitudinalCoG__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ars548_messages__msg__AccelerationLongitudinalCoG(
...
static message_type_support_callbacks_t __callbacks_AccelerationLongitudinalCoG = {
  "ars548_messages::msg",
...
static rosidl_message_type_support_t _AccelerationLongitudinalCoG__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AccelerationLongitudinalCoG,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ars548_messages, msg, AccelerationLongitudinalCoG)() {
  return &_AccelerationLongitudinalCoG__type_support;
}
